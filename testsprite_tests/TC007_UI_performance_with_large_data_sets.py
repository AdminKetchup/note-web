...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Continue with Google' button to log in and access the workspace with large data.
        ...
        # -> Input the email address to continue login process.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test failed: The editor, sidebar, and database view did not render efficiently or remain responsive with a large number of blocks and pages as required by the test plan.")
