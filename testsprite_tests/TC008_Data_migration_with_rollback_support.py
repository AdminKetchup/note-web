...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Continue with Google' button to log in and access migration features.
        ...
        # -> Input the email address to sign in and proceed with authentication.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Migration Successful').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError('Test failed: Data migration did not complete successfully or rollback did not occur as expected, indicating potential data corruption or loss.')
