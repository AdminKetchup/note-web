    ...
    return (
        <>
            ...
            >
                {/* Dialog */}
                <div
                    className="bg-white dark:bg-[#1C1C1C] rounded-lg shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <select
                                    ...
                                    className="px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#252525] text-gray-900 dark:text-gray-100"
                                >
